...
> Answer: Client side routing is the joys of using react and modern web coding techniques. When using client side routing and navigating the webpage, rendering components does not make a new network request like static routing.
